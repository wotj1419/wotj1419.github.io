...
export default function Header() {
	...
	return (
		<header
			className={`fixed z-30 w-screen border-b border-[rgba(67,58,49,0.08)] bg-[rgba(240,238,233,0.88)] backdrop-blur-lg transition-all ${isHide ? '-translate-y-full' : 'translate-y-0'}`}
		>
